<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><?= $this->Html->link("<i class='fa fa-gear'></i>" . __('Agents'), ['action' => 'index'],['escape' => false]) ?></li>
    ...
    <div class="row">
        <section class="col-lg-12 ">
            <div class="box " >
                ...
                <div class="box-body">
                    <?= $this->Form->create($agent,['id' => 'frm-default-add', 'data-toggle' => 'validator', 'role' => 'form','class' => 'form-horizontal']) ?>
                    <fieldset>        
                        <?php
                                                            echo "
