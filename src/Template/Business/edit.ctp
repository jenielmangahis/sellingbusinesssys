    ...
    <div class="row">
        <section class="col-lg-12 ">
            <div class="box " >
                ...
                <div class="box-body">
                    <?= $this->Form->create($busines,['id' => 'frm-default-add', 'data-toggle' => 'validator', 'role' => 'form','class' => 'form-horizontal']) ?>
                    <fieldset>        
                        <?php
                                                            echo "
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-sm-6'>";
                                        echo $this->Form->input('cover_photo', ['class' => 'form-control', 'id' => 'cover_photo', 'label' => false]);                
                                    echo " </div></div>";    
